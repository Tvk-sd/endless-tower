...
// Tall enough for the input + Add/Cancel row; keeps the tower from shifting on toggle
const ADD_AREA_H = 96
...
export function AddStoneButton({ onAdd }: AddStoneButtonProps) {
  ...
  return (
    <div
      ...
      style={{ height: ADD_AREA_H, width: "100%" }}
    >
      {isAdding ? (
        ...
        >
          <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
            <circle cx="22" cy="22" r="21" stroke="#000000" strokeWidth="1" />
            <line x1="22" y1="14" x2="22" y2="30" stroke="#000000" strokeWidth="1" />
            <line x1="14" y1="22" x2="30" y2="22" stroke="#000000" strokeWidth="1" />
          </svg>
        </button>
      )}
    </div>
